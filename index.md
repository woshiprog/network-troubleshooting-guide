...
<section class="hero">
  <div class="hero-inner">
    <div>
      ...
      <p class="hero-lead">
        不要一上来就重置设备。先用另一台设备、另一个网站和一次基础测试，
        把问题缩小到设备、浏览器、家庭网络或外部服务。
      </p>
    </div>
...
<section class="section">
  ...
  <p class="section-intro">
    这三项测试不会修改任何设置，通常几分钟内就能确定应该查看哪一类指南。
  </p>
  ...
  <ol class="triage-list">
    <li>
      ...
      <a href="{{ '/one-device-no-internet/' | relative_url }}">
        排查设备
      </a>
    </li>
    ...
    <li>
      ...
      <a href="{{ '/website-not-opening/' | relative_url }}">
        排查网页
      </a>
    </li>
    ...
    <li>
      ...
      <a href="{{ '/router-network-troubleshooting/' | relative_url }}">
        排查家庭网络
      </a>
    </li>
  </ol>
...
<section class="section">
  ...
  <p class="section-intro">
    每篇指南都从低风险检查开始，并说明测试结果代表什么。
    涉及删除配置、修改 DNS、网络重置或恢复出厂设置时，
    会先说明影响和恢复方法。
  </p>
  ...
  <div class="guide-grid">
    <a
      class="guide-link"
      href="{{ '/wifi-connected-no-internet/' | relative_url }}"
    >
      <small>连接状态</small>
    ...
    <a
      class="guide-link"
      href="{{ '/website-not-opening/' | relative_url }}"
    >
      <small>浏览器与网站</small>
      <strong>网页打不开</strong>
    ...
    <a
      class="guide-link"
      href="{{ '/dns-troubleshooting/' | relative_url }}"
    >
      <small>域名解析</small>
    ...
    <a
      class="guide-link"
      href="{{ '/internet-slow-troubleshooting/' | relative_url }}"
    >
      <small>连接速度</small>
    ...
    <a
      class="guide-link"
      href="{{ '/network-latency-test/' | relative_url }}"
    >
      <small>响应质量</small>
    ...
    <a
      class="guide-link"
      href="{{ '/packet-loss-test/' | relative_url }}"
    >
      <small>连接稳定性</small>
    ...
    <a
      class="guide-link"
      href="{{ '/one-device-no-internet/' | relative_url }}"
    >
      <small>设备范围</small>
    ...
    <a
      class="guide-link"
      href="{{ '/router-network-troubleshooting/' | relative_url }}"
    >
      <small>家庭网络</small>
...
<section class="section">
  ...
  <p class="section-intro">
    速度、延迟、抖动和丢包描述的是不同问题。
    测试时应记录连接方式、设备、测试对象和发生时间，
    并在相同条件下复测，才能判断变化来自哪里。
  </p>

  <p>
    <a href="{{ '/network-quality/' | relative_url }}">
      了解速度、延迟、抖动和丢包应该怎样一起看
    </a>
  </p>
</section>
...
<section class="section">
  ...
  <p class="section-intro">
    设备出现异常高温、焦味、冒烟、进水、外壳变形或反复断电时，
    应立即断开电源并联系售后。光纤折断、接口损坏或光猫持续显示
    该型号说明书定义的线路告警时，应联系运营商。
  </p>

  <p>
    公司、学校和其他受管理的网络应优先联系管理员，
    不要擅自修改代理、DNS、固定地址、路由器或安全配置。
  </p>
